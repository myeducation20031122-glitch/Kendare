...
public final class h implements Set {
    ...
    public final /* synthetic */ l.d f16993e;

    public /* synthetic */ h(l.d dVar, int i10) {
        this.f16992b = i10;
        this.f16993e = dVar;
    }
    ...
    public final boolean removeAll(Collection collection) {
        switch (this.f16992b) {
            ...
            default:
                b bVarE = this.f16993e.e();
                int i10 = bVarE.f17005f;
                Iterator it = collection.iterator();
                while (it.hasNext()) {
                    bVarE.remove(it.next());
                }
                return i10 != bVarE.f17005f;
        }
    }
    ...
    public final boolean retainAll(Collection collection) {
        switch (this.f16992b) {
            case 0:
                throw new UnsupportedOperationException();
            default:
                return l.d.n(this.f16993e.e(), collection);
        }
    }
    ...
    public final Object[] toArray(Object[] objArr) {
        switch (this.f16992b) {
            case 0:
                throw new UnsupportedOperationException();
            default:
                return this.f16993e.o(0, objArr);
        }
    }
}