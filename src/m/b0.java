...
public class b0 extends ImageButton {
    ...
    public final boolean hasOverlappingRendering() {
        return ((((ImageView) this.f14708e.f14717b).getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        c0 c0Var = this.f14708e;
        if (c0Var != null && drawable != null && !this.f14709f) {
            c0Var.f14716a = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (c0Var != null) {
            c0Var.a();
            if (this.f14709f || ((ImageView) c0Var.f14717b).getDrawable() == null) {
                return;
            }
