...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = true;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.isprid.kendare";
    ...
    private /* synthetic */ void lambda$initializeLicenseCheck$0() throws PackageManager.NameNotFoundException {
    ...
    private /* synthetic */ void lambda$initializeLicenseCheck$1(boolean z7) {
        if (z7) {
    ...
    private void processResponse(int responseCode, final Bundle responsePayload2) throws LicenseCheckException {
        try {
            if (responseCode == 3) {
